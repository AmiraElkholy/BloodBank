        ...
        <section class="signup text-center">
            <div class="container">
                ...
                <div class="py-4 mb-4">
                    ...
                    <form action="{{route('clientsRegisterSubmit')}}" method="POST" class="w-75 m-auto">
                        {{csrf_field()}}

                        <div>
                            <input type="text" name="name" class="form-control my-3" placeholder="الاسم" value="{{old('name')}}">
                        </div>
                        <div>
                            <input type="mail" name="email" class="form-control my-3" placeholder="البريد الاليكترونى" value="{{old('email')}}">
                        </div>
                        <div class="input-group">
                            <input type="text"  id="birthdaypicker" name="date_of_birth" class="form-control" id="birthdaypicker" placeholder="تاريخ الميلاد" value="{{old('date_of_birth')}}">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="last_donation_date" class="form-control" id="donationdatepicker" placeholder="اخر تاريخ تبرع" value="{{old('last_donation_date')}}" aria-label="Username" aria-describedby="basic-addon1">
                            <i class="far fa-calendar-alt"></i>
                        </div>
